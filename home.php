...
<body>
	<div class="container" >
		...
		<div class="container">
		<h1 class="text-secondary text-opacity-50">APLIKASI KEBERSIHAN TOILET</h1>
		</div>
		</div>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item">
							<a class="nav-link" href="data.php">Laporan</a>
						</li>
					</ul>
				</div>
                </span>
    ...
    <div class="mx-auto">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="num" class="form-control" id="toilet_id" name="toilet_id" value="<?php echo $toilet_id ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="date"><?php echo $tanggal ?></td>
                ...
                <footer>
                    <p>UNIVERSITAS PELITA BANGSA 2021</p>
                </footer>
            </div>
        </div>
    </div>
